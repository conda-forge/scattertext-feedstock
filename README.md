About scattertext-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scattertext-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4553&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scattertext-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scattertext` can be installed with `conda`:
...
```
mamba install scattertext
```

It is possible to list all of the versions of `scattertext` available on your platform with `conda`:
...
```
mamba search scattertext --channel conda-forge
```
...
mamba repoquery search scattertext --channel conda-forge

# List packages depending on `scattertext`:
mamba repoquery whoneeds scattertext --channel conda-forge

# List dependencies of `scattertext`:
mamba repoquery depends scattertext --channel conda-forge
```
